...
response <- provider$chat$chat_structured(
...
promise <- provider$chat$chat_async("What is the capital of France?")
...
```{r}
# These work with both provider types
provider <- new_ellmer_anthropic() |>
...
- See `?new_ellmer_provider` for detailed documentation
