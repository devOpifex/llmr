...
```{r create-agent}
# Create an agent with a descriptive name and the Anthropic provider factory
agent <- new_agent("calculator", new_anthropic)
```

**Important:** You'll need an Anthropic API key for this to work. You can get one from [Anthropic's website](https://console.anthropic.com/).
