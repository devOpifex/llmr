...
technical_writer <- new_agent("technical_writer", new_anthropic)
creative_writer <- new_agent("creative_writer", new_anthropic)
data_analyst <- new_agent("data_analyst", new_anthropic)
