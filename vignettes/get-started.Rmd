...
request(agent, "I have 100 dollars and spend 23.50 on groceries and 15.75 on gas. How much do I have left?")
get_last_message(agent)
```
...
The llmr package makes it easy to create powerful AI agents that can interact with your R environment and perform real work. Start simple with tools like our calculator, then gradually build more sophisticated capabilities as you become comfortable with the framework.
