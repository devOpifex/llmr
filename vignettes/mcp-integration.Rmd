...
# Create an agent with the Anthropic provider factory
...
agent1 <- new_agent("financial_advisor", new_anthropic)
agent2 <- new_agent("math_tutor", new_anthropic)
agent3 <- new_agent("data_analyst", new_anthropic)
